...
def train_classifier(
        ...
        save_path: str,
        patience: int = 10,
        loss_fn: nn.CrossEntropyLoss | nn.BCELoss | nn.BCEWithLogitsLoss = nn.CrossEntropyLoss()
    ):
    '''
    Train a language model with early stopping on validation accuracy.
    '''
    ...
    for ep in range(n_epochs):
        ...
        for batch in train_dl:
            ...
            # Loss is typically CrossEntropyLoss, but can be BCELoss for binary classification
